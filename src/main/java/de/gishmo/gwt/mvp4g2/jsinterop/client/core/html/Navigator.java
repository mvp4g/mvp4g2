...
public class Navigator {
  ...
  /**
   * Returns the UserAgent of the property
   *
   * @return The UserAgent of the property
   */
  @JsProperty
  public native String getUserAgent();

  /**
   * Returns the appName String of the property
   *
   * @return the appName String of the property
   */
  @JsProperty
