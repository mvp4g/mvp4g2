...
package org.gwt4e.mvp4g2.processor.context;

import com.squareup.javapoet.ClassName;
import org.gwt4e.mvp4g2.client.Mvp4g2EventBus;
import org.gwt4e.mvp4g2.client.annotations.EventBus;
import org.gwt4e.mvp4g2.processor.ProcessorContext;
import org.gwt4e.mvp4g2.processor.Utils;
    ...
    if (!types.isSubtype(element.asType(),
      ...
      messager.printMessage(Diagnostic.Kind.ERROR,
                            String.format("%s: %s applied on a type that doesn't implement %s; ignoring",
                                          ...
                                          Mvp4g2EventBus.class.getCanonicalName()));
      return null;
    }
