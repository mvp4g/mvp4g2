...
public class ShellAttributeValidator {
  ...
  private ShellAttributeValidator() {
  }

  private ShellAttributeValidator(Builder builder) {
  ...
  public static final class Builder {
    ...
    public ShellAttributeValidator build() {
      return new ShellAttributeValidator(this);
    }
  }
}
