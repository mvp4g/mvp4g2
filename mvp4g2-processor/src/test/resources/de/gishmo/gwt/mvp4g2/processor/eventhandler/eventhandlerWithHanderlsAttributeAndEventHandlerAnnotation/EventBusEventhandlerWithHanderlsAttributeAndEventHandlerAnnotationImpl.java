...
public final class EventBusEventhandlerWithHanderlsAttributeAndEventHandlerAnnotationImpl extends AbstractEventBus<EventBusEventhandlerWithHanderlsAttributeAndEventHandlerAnnotation> implements EventBusEventhandlerWithHanderlsAttributeAndEventHandlerAnnotation {
  public EventBusEventhandlerWithHanderlsAttributeAndEventHandlerAnnotationImpl() {
    super("de.gishmo.gwt.mvp4g2.processor.eventhandler.eventhandlerWithHanderlsAttributeAndEventHandlerAnnotation.MockShellPresenter01");
  }
  ...
  protected void loadEventMetaData() {
    ...
    // ----------------------------------------------------------------------
    //
    // handle De_gishmo_gwt_mvp4g2_processor_eventhandler_eventhandlerWithHanderlsAttributeAndEventHandlerAnnotation_EventBusEventhandlerWithHanderlsAttributeAndEventHandlerAnnotation_doSomething01
    //
    super.putEventMetaData("doSomething01_pPp_java_lang_String", new De_gishmo_gwt_mvp4g2_processor_eventhandler_eventhandlerWithHanderlsAttributeAndEventHandlerAnnotation_EventBusEventhandlerWithHanderlsAttributeAndEventHandlerAnnotation_doSomething01());
  }
  ...
  public final void execDoSomething01(final String oneAttribute) {
    ...
    // handling: de.gishmo.gwt.mvp4g2.processor.eventhandler.eventhandlerWithHanderlsAttributeAndEventHandlerAnnotation.MockShellPresenter01
    presenters = this.presenterMetaDataMap.get("de.gishmo.gwt.mvp4g2.processor.eventhandler.eventhandlerWithHanderlsAttributeAndEventHandlerAnnotation.MockShellPresenter01");
  ...
  protected void loadEventHandlerMetaData() {
    //
    // ===>
    // handle de.gishmo.gwt.mvp4g2.processor.eventhandler.eventhandlerWithHanderlsAttributeAndEventHandlerAnnotation.MockShellPresenter01 (Presenter)
    //
    De_gishmo_gwt_mvp4g2_processor_eventhandler_eventhandlerWithHanderlsAttributeAndEventHandlerAnnotation_MockShellPresenter01MetaData de_gishmo_gwt_mvp4g2_processor_eventhandler_eventhandlerWithHanderlsAttributeAndEventHandlerAnnotation_MockShellPresenter01MetaData = new De_gishmo_gwt_mvp4g2_processor_eventhandler_eventhandlerWithHanderlsAttributeAndEventHandlerAnnotation_MockShellPresenter01MetaData();
    super.putPresenterMetaData("de.gishmo.gwt.mvp4g2.processor.eventhandler.eventhandlerWithHanderlsAttributeAndEventHandlerAnnotation.MockShellPresenter01", de_gishmo_gwt_mvp4g2_processor_eventhandler_eventhandlerWithHanderlsAttributeAndEventHandlerAnnotation_MockShellPresenter01MetaData);
    de_gishmo_gwt_mvp4g2_processor_eventhandler_eventhandlerWithHanderlsAttributeAndEventHandlerAnnotation_MockShellPresenter01MetaData.getPresenter().setEventBus(this);
    de_gishmo_gwt_mvp4g2_processor_eventhandler_eventhandlerWithHanderlsAttributeAndEventHandlerAnnotation_MockShellPresenter01MetaData.getPresenter().setView(de_gishmo_gwt_mvp4g2_processor_eventhandler_eventhandlerWithHanderlsAttributeAndEventHandlerAnnotation_MockShellPresenter01MetaData.getView());
    de_gishmo_gwt_mvp4g2_processor_eventhandler_eventhandlerWithHanderlsAttributeAndEventHandlerAnnotation_MockShellPresenter01MetaData.getView().setPresenter(de_gishmo_gwt_mvp4g2_processor_eventhandler_eventhandlerWithHanderlsAttributeAndEventHandlerAnnotation_MockShellPresenter01MetaData.getPresenter());
    //
