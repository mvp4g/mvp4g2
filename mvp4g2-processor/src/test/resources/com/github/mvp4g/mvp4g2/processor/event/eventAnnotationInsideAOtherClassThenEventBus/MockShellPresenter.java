...
package com.github.mvp4g.mvp4g2.processor.event.eventAnnotationInsideAOtherClassThenEventBus;
...
public class MockShellPresenter
  extends AbstractPresenter<EventAnnotationInsideAOtherClassThenEventBus, IMockShellView>
  implements IMockShellView.Presenter,
             IsShell<EventAnnotationInsideAOtherClassThenEventBus, IMockShellView> {
