...
public final class StartEventTestEventBusWithOneStartAnnotationImpl extends AbstractEventBus<StartEventTestEventBusWithOneStartAnnotation> implements StartEventTestEventBusWithOneStartAnnotation {
  public StartEventTestEventBusWithOneStartAnnotationImpl() {
    super("com.github.mvp4g.mvp4g2.processor.event.startEventTestEventBusWithOneStartAnnotation.MockShellPresenter");
  }
  ...
  public final void execStart() {
    ...
    // handling: com.github.mvp4g.mvp4g2.processor.event.startEventTestEventBusWithOneStartAnnotation.MockShellPresenter
    presenters = this.presenterMetaDataMap.get("com.github.mvp4g.mvp4g2.processor.event.startEventTestEventBusWithOneStartAnnotation.MockShellPresenter");
  ...
  protected void loadEventHandlerMetaData() {
    //
    // ===>
    // handle com.github.mvp4g.mvp4g2.processor.event.startEventTestEventBusWithOneStartAnnotation.MockShellPresenter (Presenter)
    //
    ...
    super.putPresenterMetaData("com.github.mvp4g.mvp4g2.processor.event.startEventTestEventBusWithOneStartAnnotation.MockShellPresenter", com_github_mvp4g_mvp4g2_processor_event_startEventTestEventBusWithOneStartAnnotation_MockShellPresenterMetaData);
