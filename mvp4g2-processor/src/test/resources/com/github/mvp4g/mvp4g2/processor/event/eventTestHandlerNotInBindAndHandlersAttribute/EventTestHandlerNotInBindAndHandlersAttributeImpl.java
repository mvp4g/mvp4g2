...
public final class EventTestHandlerNotInBindAndHandlersAttributeImpl extends AbstractEventBus<EventTestHandlerNotInBindAndHandlersAttribute> implements EventTestHandlerNotInBindAndHandlersAttribute {
  ...
  public final void execEvent02() {
    ...
    // handling: com.github.mvp4g.mvp4g2.processor.event.eventTestHandlerNotInBindAndHandlersAttribute.MockShellPresenter
    presenters = this.presenterMetaDataMap.get("com.github.mvp4g.mvp4g2.processor.event.eventTestHandlerNotInBindAndHandlersAttribute.MockShellPresenter");
  ...
  public final void execEvent01() {
    ...
    List<PresenterMetaData<?, ?>> presenters = null;
    List<String> listOfExecutedHandlers = new ArrayList<>();
    // handling: com.github.mvp4g.mvp4g2.processor.event.eventTestHandlerNotInBindAndHandlersAttribute.MockOneEventHandler
    handlers = this.handlerMetaDataMap.get("com.github.mvp4g.mvp4g2.processor.event.eventTestHandlerNotInBindAndHandlersAttribute.MockOneEventHandler");
  ...
  protected void loadEventHandlerMetaData() {
    //
    // ===>
    // handle com.github.mvp4g.mvp4g2.processor.event.eventTestHandlerNotInBindAndHandlersAttribute.MockShellPresenter (Presenter)
    //
    ...
    super.putPresenterMetaData("com.github.mvp4g.mvp4g2.processor.event.eventTestHandlerNotInBindAndHandlersAttribute.MockShellPresenter", com_github_mvp4g_mvp4g2_processor_event_eventTestHandlerNotInBindAndHandlersAttribute_MockShellPresenterMetaData);
    ...
    //
    // ===>
    // handle com.github.mvp4g.mvp4g2.processor.event.eventTestHandlerNotInBindAndHandlersAttribute.MockOneEventHandler (EventHandler)
    //
    ...
    super.putHandlerMetaData("com.github.mvp4g.mvp4g2.processor.event.eventTestHandlerNotInBindAndHandlersAttribute.MockOneEventHandler", com_github_mvp4g_mvp4g2_processor_event_eventTestHandlerNotInBindAndHandlersAttribute_MockOneEventHandlerMetaData);
    ...
    super.getEventMetaData("event01").addHandler("com.github.mvp4g.mvp4g2.processor.event.eventTestHandlerNotInBindAndHandlersAttribute.MockOneEventHandler");
  }
}