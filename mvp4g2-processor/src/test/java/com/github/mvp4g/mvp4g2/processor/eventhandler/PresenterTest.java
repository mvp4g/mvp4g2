...
public class PresenterTest {
  ...
  public void testPresenterAnnotationAnnotatedOnAbstractClass() {
    ASSERT.about(javaSource())
          .that(JavaFileObjects.forResource("com/github/mvp4g/mvp4g2/processor/eventhandler/presenterAnnotationAnnotatedOnAbstractClass" + "/PresenterAnnotationAnnotatedOnAbstractClass.java"))
  ...
  public void testPresenterAnnotationAnnotatedOnAInterface() {
    ASSERT.about(javaSource())
          .that(JavaFileObjects.forResource("com/github/mvp4g/mvp4g2/processor/eventhandler/presenterAnnotationAnnotatedOnAInterface/PresenterAnnotationAnnotatedOnAInterface.java"))
          .processedWith(new Mvp4g2Processor())
          .failsToCompile()
  ...
  public void testPresenterNotExtendingAbstractPresenter() {
    ASSERT.about(javaSource())
          .that(JavaFileObjects.forResource("com/github/mvp4g/mvp4g2/processor/eventhandler/presenterAnnotationNotExtendingAbstractPresenter/PresenterAnnotationNotExtendingAbstractPresenter.java"))
          .processedWith(new Mvp4g2Processor())
          .failsToCompile()
  ...
  public void testPresenterAnnotationUsingViewClassAsInterface() {
    ASSERT.about(javaSource())
          .that(JavaFileObjects.forResource("com/github/mvp4g/mvp4g2/processor/eventhandler/presenterAnnotationUsingViewClassAsInterface/PresenterAnnotationUsingViewClassAsInterface.java"))
          .processedWith(new Mvp4g2Processor())
          .failsToCompile()
  ...
  public void testPresenterAnnotationUsingViewAbstractClass() {
    ASSERT.about(javaSource())
          .that(JavaFileObjects.forResource("com/github/mvp4g/mvp4g2/processor/eventhandler/presenterAnnotationUsingViewAbstractClass/PresenterAnnotationUsingViewAbstractClass.java"))
          .processedWith(new Mvp4g2Processor())
          .failsToCompile()
  ...
  public void testPresenterOK() {
    ASSERT.about(javaSources())
          ...
          .and()
          .generatesSources(JavaFileObjects.forResource("com/github/mvp4g/mvp4g2/processor/eventhandler/presenterOK/Com_github_mvp4g_mvp4g2_processor_eventhandler_presenterOK_PresenterOKMetaData.java"));
  }
  ...
  public void testEventHandlingMethodDoesNotReturnVoid03() {
    ASSERT.about(javaSources())
          ...
          .processedWith(new Mvp4g2Processor())
          .failsToCompile()
          .withErrorContaining("Mvp4g2Processor: >>com.github.mvp4g.mvp4g2.processor.eventhandler.eventHandlingMethodDoesNotReturnVoid03.MockShellPresenter01<< -> EventElement: >>onDoSomething()<< must return 'void'");
  }
  ...
  public void testEventHandlingMethodDoesNotReturnVoid04() {
    ASSERT.about(javaSources())
          ...
          .processedWith(new Mvp4g2Processor())
          .failsToCompile()
          .withErrorContaining("Mvp4g2Processor: >>com.github.mvp4g.mvp4g2.processor.eventhandler.eventHandlingMethodDoesNotReturnVoid04.MockShellPresenter01<< -> EventElement: >>onDoSomething()<< must return 'void'");
  }
  ...
  public void testEventBusEventhandlerWithHanderlsAttributeAndEventHandlerAnnotation() {
    ASSERT.about(javaSources())
          ...
          .compilesWithoutError()
          .and()
          .generatesSources(JavaFileObjects.forResource("com/github/mvp4g/mvp4g2/processor/eventhandler/eventhandlerWithHanderlsAttributeAndEventHandlerAnnotation/EventBusEventhandlerWithHanderlsAttributeAndEventHandlerAnnotationImpl.java"));
  }
