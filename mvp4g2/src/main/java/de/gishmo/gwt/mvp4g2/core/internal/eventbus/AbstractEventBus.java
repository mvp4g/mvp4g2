...
public abstract class AbstractEventBus<E extends IsEventBus>
   ...
   * (non-Javadoc)
   *
   * @see de.gishmo.gwt.mvp4g2.core.eventbus.IsEventBus#addEventFilter(de.gishmo.gwt.mvp4g2.core.eventbus.IsEventFilter)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see de.gishmo.gwt.mvp4g2.core.eventbus.IsEventBus#removeEventFilter(cde.gishmo.gwt.mvp4g2.core.eventbus.IsEventFilter)
   */
  @Override
